...
$(window).load(function(){
    ...
    var myOptions = {
        zoom: 14,
        center: new google.maps.LatLng(37.468356, 127.039012), //change the coordinates
    ...
    marker = new google.maps.Marker({
        map: map,
        position: new google.maps.LatLng(37.468356, 127.039012) //change the coordinates
    });
    infowindow = new google.maps.InfoWindow({
        content: "<b>aT Center</b><br/>3층 세계로룸(중회의실)<br/> 양재"  //add your address
    });
